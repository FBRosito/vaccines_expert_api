...
Maps each IN 2026 regulatory clause to:
  - The rule module that implements it (app/expert_system/rules/)
...
Run:
    PYTHONPATH=. python3 traceability/traceability_matrix.py
Output:
...
MATRIZ = [
    # ── BCG ──────────────────────────────────────────────────────────────────
    {
        ...
        'Module': 'app/expert_system/rules/bcg.py — rule_bcg_recommend_now',
    ...
    },
    {
        ...
        'Module': 'app/expert_system/rules/bcg.py — rule_bcg_contraindicated_by_age',
    ...
    # ── Hepatite B ───────────────────────────────────────────────────────────
    {
        ...
        'Module': 'app/expert_system/rules/hepatitis_b.py',
    ...
    },
    {
        ...
        'Module': 'app/expert_system/rules/hepatitis_b.py — rule_hep_b_over7_recommend_now',
    ...
    # ── Penta + DTP ──────────────────────────────────────────────────────────
    {
        ...
        'Module': 'app/expert_system/rules/penta_dtp.py — RulesPentaDTP',
    ...
    # ── VIP ──────────────────────────────────────────────────────────────────
    {
        ...
        'Module': 'app/expert_system/rules/vip.py',
    ...
    # ── Rotavírus ─────────────────────────────────────────────────────────────
    {
        ...
        'Module': 'app/expert_system/rules/rotavirus.py',
    ...
    # ── Pneumo10 ─────────────────────────────────────────────────────────────
    {
        ...
        'Module': 'app/expert_system/rules/pneumo10.py',
    ...
    # ── Meningocócica ─────────────────────────────────────────────────────────
    {
        ...
        'Module': 'app/expert_system/rules/meningo.py',
    ...
    # ── Influenza ─────────────────────────────────────────────────────────────
    {
        ...
        'Module': 'app/expert_system/rules/influenza.py',
    ...
    },
    {
        ...
        'Module': 'app/expert_system/rules/influenza.py — rule_influenza_elderly_annual',
    ...
    },
    {
        ...
        'Module': 'app/expert_system/rules/influenza.py — rule_influenza_adolescent_adult_annual',
    ...
    },
    {
        ...
        'Module': 'app/expert_system/rules/influenza.py — rule_influenza_outside_target_group',
    ...
    # ── COVID-19 ──────────────────────────────────────────────────────────────
    {
        ...
        'Module': 'app/expert_system/rules/covid19.py',
    ...
    },
    {
        ...
        'Module': 'app/expert_system/rules/covid19.py — rule_covid_elderly_recommend',
    ...
    },
    {
        ...
        'Module': 'app/expert_system/rules/covid19.py — rule_covid_adult_recommend',
    ...
    },
    {
        ...
        'Module': 'app/expert_system/rules/covid19.py — rule_covid_not_recommended_priority',
    ...
    # ── Febre Amarela ─────────────────────────────────────────────────────────
    {
        ...
        'Module': 'app/expert_system/rules/live_attenuated_viruses.py — RulesLiveAttenuatedViruses',
    ...
    },
    {
        ...
        'Module': 'app/expert_system/rules/live_attenuated_viruses.py — rule_fa_contraindicated_elderly',
    ...
    # ── SCR (Tríplice Viral) ──────────────────────────────────────────────────
    {
        ...
        'Module': 'app/expert_system/rules/live_attenuated_viruses.py',
    ...
    },
    {
        ...
        'Module': 'app/expert_system/rules/live_attenuated_viruses.py — rule_priority_scr_over_fa',
        'Test_Cases': 'VV-12',
        'Status': 'Covered',
    ...
    # ── Hepatite A ────────────────────────────────────────────────────────────
    {
        ...
        'Module': 'app/expert_system/rules/hepatitis_a.py',
    ...
    # ── HPV ──────────────────────────────────────────────────────────────────
    {
        ...
        'Module': 'app/expert_system/rules/hpv.py',
    ...
    # ── dT Adulto ────────────────────────────────────────────────────────────
    {
        ...
        'Module': 'app/expert_system/rules/dt_adult.py',
    ...
    # ── Pneumo23 ─────────────────────────────────────────────────────────────
    {
        ...
        'Module': 'app/expert_system/rules/pneumo23.py',
    ...
    # ── Dengue ───────────────────────────────────────────────────────────────
    {
        ...
        'Module': 'app/expert_system/rules/dengue.py',
